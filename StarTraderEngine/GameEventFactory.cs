...
namespace StarTrader
{
    ...
    {
        public static List<GameEvent> CreateEvents()
        {
            return new List<GameEvent>()
            {
                ...
                new Opportunity.Hull(1, new Connections.Criminal(10), true,  "Hull Javelin", StarSystemType.BetaHydri, HullType.Javelin, 5),
                ...
                new Opportunity.Hull(4, new Connections.Economic(3), true, "Hull Dagger", StarSystemType.TauCeti, HullType.Dagger, 1),
                ...
                new Opportunity.Hull(2, new Connections.Economic(10), true, "Any black market hull", StarSystemType.MuHerculis, null, 5),
                // Any black market hull and/or 5 modules. Available on Mu Herkulis.
                new Opportunity.Hull(2, new Connections.Criminal(8), true,  "Hull Sword", StarSystemType.MuHerculis, HullType.Sword, 3),
                ...
                new Opportunity.Hull(3, new Connections.Criminal(4), true,  "Hull Dagger", StarSystemType.SigmaDraconis, HullType.Dagger, 1),
